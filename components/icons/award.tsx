...
const Award = ({ size = 24, ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g>
      ...
      />
      <defs>
        <linearGradient id="aw_grad_1" x1="12" y1="-.5" x2="12" y2="23.126" gradientUnits="userSpaceOnUse">
          <stop stopColor="#575757" />
          <stop offset="1" stopColor="#151515" />
        </linearGradient>
        <linearGradient id="aw_grad_2" x1="12" y1="1" x2="12" y2="18" gradientUnits="userSpaceOnUse">
          <stop stopColor="#E3E3E5" stopOpacity=".6" />
          <stop offset="1" stopColor="#BBBBC0" stopOpacity=".6" />
        </linearGradient>
        <linearGradient id="aw_grad_3" x1="12" y1="1" x2="12" y2="10.845" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fff" />
