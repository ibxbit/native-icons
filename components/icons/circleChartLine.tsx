...
export const CircleChartLineSVG = () => (
  <g fill="none">
    {/* 1. The Slice (Background Layer) */}
    <path
    ...
    {/* 2. The Blurred Shadow Layer */}
    <path
      d="M18.3301 4.25763C14.4021 1.03823 8.59588 1.262 4.92894 4.92893C3.23057 6.6273 2.27082 8.78459 2.04967 11.0016C1.99485 11.5512 2.44773 12 3.00001 12H12L18.364 5.63604C18.7545 5.24551 18.7573 4.60772 18.3301 4.25763Z"
      fill="url(#ccl_grad_0)"
      filter="url(#ccl_filter)"
      clipPath="url(#ccl_clip)"
    />

    {/* 3. The Main Glass Body */}
    <path
    ...
    <defs>
      <linearGradient id="ccl_grad_0" x1="10.35" y1="2" x2="10.35" y2="12" gradientUnits="userSpaceOnUse">
        <stop stopColor="#575757" />
        <stop offset="1" stopColor="#151515" />
      </linearGradient>
      
      <linearGradient id="ccl_grad_1" x1="3.083" y1="5.361" x2="18.639" y2="20.917" gradientUnits="userSpaceOnUse">
        <stop stopColor="#E3E3E5" stopOpacity="0.6" />
        <stop offset="1" stopColor="#BBBBC0" stopOpacity="0.6" />
      </linearGradient>
      
      <linearGradient id="ccl_grad_2" x1="11.979" y1="4.639" x2="11.979" y2="15.272" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
        <stop offset="1" stopColor="#fff" stopOpacity="0" />
      </linearGradient>

      <filter id="ccl_filter">
        <feGaussianBlur stdDeviation="2" />
      </filter>

      <clipPath id="ccl_clip">
...
export default function CircleChartLine({ size = 24, ...props }: { size?: number; [key: string]: any }) {
  return (
