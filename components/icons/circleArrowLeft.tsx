...
export const CircleArrowLeftSVG = () => (
  <g fill="none">
    {/* The Main Arrow (Background layer) */}
    <path
      ...
      fill="url(#cal_grad_0)"
      mask="url(#cal_mask_main)"
    />
    
    {/* The Blurred Shadow Layer (The "Glass" depth) */}
    <path
      d="M16.0001 7.61319C15.9999 5.90661 13.9844 4.90601 12.5177 5.88467L5.94444 10.2714C4.68584 11.1112 4.68584 12.8886 5.94444 13.7284L12.5177 18.1151C13.9845 19.0939 16.0001 18.0934 16.0001 16.3866V13.4999H21.0001L21.1534 13.4921C21.9098 13.4153 22.5001 12.7766 22.5001 11.9999C22.5 11.2233 21.9098 10.5845 21.1534 10.5077L21.0001 10.4999H16.0001V7.61319Z"
      fill="url(#cal_grad_0)"
      filter="url(#cal_filter_blur)"
      clipPath="url(#cal_clip_circle)"
    />

    {/* The Translucent Circle Face */}
    <path
      fillRule="evenodd"
      clipRule="evenodd"
    ...
    <defs>
      <linearGradient id="cal_grad_0" x1="13.75" y1="5.5" x2="13.75" y2="18.5" gradientUnits="userSpaceOnUse">
        <stop stopColor="#575757" />
        <stop offset="1" stopColor="#151515" />
      </linearGradient>
      
      <linearGradient id="cal_grad_1" x1="12" y1="1" x2="12" y2="23" gradientUnits="userSpaceOnUse">
        <stop stopColor="#E3E3E5" stopOpacity="0.6" />
        <stop offset="1" stopColor="#BBBBC0" stopOpacity="0.6" />
      </linearGradient>
      
      <linearGradient id="cal_grad_2" x1="12" y1="1" x2="12" y2="13.74" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
        <stop offset="1" stopColor="#fff" stopOpacity="0" />
      </linearGradient>

      <filter id="cal_filter_blur" x="-100%" y="-100%" width="400%" height="400%" filterUnits="objectBoundingBox">
        <feGaussianBlur stdDeviation="2" />
      </filter>

      {/* This clip ensures the blur only shows inside the circle/arrow combo */}
      <clipPath id="cal_clip_circle">
      ...
      {/* This mask punches a hole in the arrow where the circle overlaps */}
      <mask id="cal_mask_main">
...
export default function CircleArrowLeft({ size = 24, ...props }: { size?: number; [key: string]: any }) {
  return (
