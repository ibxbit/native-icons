...
export const BugSVG = () => (
  <g fill="none">
    ...
    <path
      ...
      clipPath="url(#bug_clipPath)"
    />

    {/* Main body with semi-transparent gradient */}
    <path
    ...
    <defs>
      <linearGradient id="bug_grad_0" x1="12" y1="-1" x2="12" y2="21" gradientUnits="userSpaceOnUse">
        <stop stopColor="#575757" />
        <stop offset="1" stopColor="#151515" />
      </linearGradient>
      <linearGradient id="bug_grad_1" x1="12" y1="5" x2="12" y2="21" gradientUnits="userSpaceOnUse">
        <stop stopColor="#E3E3E5" stopOpacity="0.6" />
        <stop offset="1" stopColor="#BBBBC0" stopOpacity="0.6" />
      </linearGradient>
      <linearGradient id="bug_grad_2" x1="12" y1="5" x2="12" y2="14.266" gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
...
export default function Bug({ size = 24, ...props }: { size?: number; [key: string]: any }) {
  return (
